...
namespace S12005ObjectDefinitions.SLZ
{
	class SwingingPlatform : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../art/nemesis/slzswing.bin", CompressionType.Nemesis), "../mappings/sprite/obj15slz.asm", labels[i], i == 1 ? 0 : 2));
		}
