...
Notice_GotoTitle:
		...
		rts	
; ---------------------------------------------------------------------------
Art_Notice:		incbin	"_notice\Art.bin"		; rename to your needs
			even
Map_Notice:		incbin	"_notice\Map.bin"		; rename to your needs
			even
Pal_Notice:		incbin	"_notice\Palette.bin"		; rename to your needs
			even