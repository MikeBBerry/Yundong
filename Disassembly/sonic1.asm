...
Resize_SBZ3:
		...
		bcs.s	locret_6F8C
		cmpi.w	#$18,(Object_Space_1+$C).w ; has Sonic reached the top of the level?
...
Boundary_Bottom:
		...
		cmpi.w	#$2000,(Object_Space_1+8).w
